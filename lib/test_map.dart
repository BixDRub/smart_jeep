...
class _TestMapState extends State<TestMap> with SingleTickerProviderStateMixin {
  ...
  bool transmit = true; // Set to true to send GPS coordinates

  @override
  void initState() {
    super.initState();

    // Safe selectedRoute setup
  ...
  void _startGpsUpdates() async {
    ...
    positionStream = Geolocator.getPositionStream(
      ...
      setState(() => vehiclePosition = newPos);
      _mapController.move(newPos, 16); // optional: auto-center map

      // SEND COORDS BLYAD SUKA
      if (transmit && channel != null) {
